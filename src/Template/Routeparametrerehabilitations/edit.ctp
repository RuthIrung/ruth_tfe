...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $routeparametrerehabilitation->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $routeparametrerehabilitation->id)]
            )
        ?></li>
...
<div class="routeparametrerehabilitations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Modifier Routeparametrerehabilitation') ?></legend>
        <?php
