...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Modifier Utilisateur'), ['action' => 'edit', $utilisateur->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Supprimer Utilisateur'), ['action' => 'delete', $utilisateur->id], ['confirm' => __('Are you sure you want to delete # {0}?', $utilisateur->id)]) ?> </li>
