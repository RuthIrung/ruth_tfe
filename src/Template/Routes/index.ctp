    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('Coordonnees') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Voir'), ['action' => 'view', $route->id]) ?>
                    <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $route->id]) ?>
                    <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $route->id], ['confirm' => __('Are you sure you want to delete # {0}?', $route->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
